...
router.get('/review/product/:id', productMiddleware.findId, reviewMiddleware.validateGetReview, reviewController.getProductReview)
...
router.get('/review/', userMiddleware.authenticateToken, reviewMiddleware.validateGetReview, reviewController.getOwnReview)
